      ...
      <div className="sticky top-0 z-50 border-b border-gold/20 bg-gold/10 backdrop-blur-sm">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-6 py-3">
          <div className="flex items-center gap-4">
            <Link href="/" className="font-serif text-lg font-semibold text-[#C8A96B] shrink-0">
              RentalOS
            </Link>
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-gold px-4 py-1.5
              font-sans text-xs font-medium text-black hover:opacity-90 transition-opacity whitespace-nowrap"
          >
            Start free trial
