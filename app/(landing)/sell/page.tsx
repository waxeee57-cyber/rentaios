...
export const metadata: Metadata = {
  title: 'RentalOS — Luxury Rental Booking System Template',
  description:
    'A complete luxury rental booking system. Next.js 15, Supabase, admin panel, email notifications, mobile-first. Deploy in one day. MIT license.',
  openGraph: {
    title: 'RentalOS — Luxury Rental Booking System Template',
    description:
      'Full Next.js 15 booking system with admin panel, email notifications, and Supabase backend. Deploy in one day.',
  },
}
...
const FAQ_ITEMS = [
  ...
  {
    q: 'Is there a demo?',
    a: 'Yes. The live reference is costasol.vercel.app — a real luxury car rental business in Marbella running on this exact codebase.',
  },
  {
...
export default function SellPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* ── Sticky nav ─────────────────────────────────────────── */}
      <nav aria-label="Page" className="fixed inset-x-0 top-0 z-50 border-b border-border bg-black/90 backdrop-blur-md">
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 pb-20 pt-32 text-center">
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-8">
          ...
          <p className="max-w-lg font-sans text-base leading-relaxed text-muted">
            Next.js 15 · Supabase · Admin panel · Email notifications · Mobile-first
          </p>
      ...
      <footer className="border-t border-border py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-6 text-center md:flex-row md:justify-between md:text-left">
          <p className="font-sans text-xs text-muted">
            RentalOS — Built on the same system powering{' '}
            <a
              href="https://drivecostasol.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gold underline-offset-4 hover:underline focus-visible:outline-none focus-visible:underline"
            >
              drivecostasol.com
            </a>
          </p>
          {adminEmail && (
            <a
              ...
              className="font-sans text-xs text-muted transition-colors hover:text-white focus-visible:outline-none focus-visible:text-white"
            >
              {adminEmail}
            </a>
          )}
