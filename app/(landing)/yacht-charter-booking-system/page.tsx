    ...
    <div className="bg-white min-h-screen text-gray-900">
      ...
      <div className="mx-auto max-w-4xl px-6 pt-10 pb-2">
        <nav className="font-sans text-xs text-muted" aria-label="Breadcrumb">
          ...
          <span className="mx-2">›</span>
          <span className="text-muted">Yacht charter booking system</span>
        </nav>
      </div>
      ...
      <section className="border-t border-border bg-surface px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/pricing" className="inline-flex items-center min-h-[48px] rounded-md bg-gold px-8 font-sans text-sm font-medium text-gray-900 hover:opacity-90 transition-opacity">
              Start free trial
            </Link>
            <Link href="/demo" className="inline-flex items-center min-h-[48px] rounded-md border border-border px-8 font-sans text-sm text-muted hover:border-gold/40 hover:text-gray-900 transition-colors">
              See live demo
            </Link>
          </div>
        </div>
