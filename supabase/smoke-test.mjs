...
//
// CI acceptance test for the P0 RLS lockdown (19_security_rls_p0.sql) +
// admin_users reconcile (20_admin_users_reconcile.sql).
//
...
function testMigrationsExist() {
  ...
  for (const f of ['19_security_rls_p0.sql', '20_admin_users_reconcile.sql']) {
